...
public class Panel_Tam_Instrucciones extends JPanel {
	...
	public void inicializarArea() {
		...
		area_instrucciones = new JTextArea("1. El objetivo del juego es ser el primer jugador en llegar hasta el final moviéndote a " + "\r\n"
	...
	public void inicializarBarra() {
		...
		barraDesplazamiento = new JScrollPane(area_instrucciones);
		barraDesplazamiento.setBounds(10, 25, 515, 185);
